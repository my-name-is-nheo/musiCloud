...
(function() {
        ...
        if ((list = this._events[name])) {
          ...
          if (callback || context) {
            for (j = 0, k = list.length; j < k; j++) {
              ...
              if (
                (callback &&
                  callback !== (ev.callback._callback || ev.callback)) ||
  ...
  // Allow the `Backbone` object f serve as a global event bus, for folks who
  ...
  _.extend(Collection.prototype, Events, {
    ...
    add: function(models, options) {
      ...
      if (needsSort && this.comparator && at == null)
    ...
    get: function(obj) {
      ...
      return (
        this._byId[obj.id != null ? obj.id : obj] || this._byCid[obj.cid || obj]
      );
    },
